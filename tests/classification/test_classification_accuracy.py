...
def test_classification_accuracy_mask():
    metric = ClassificationAccuracy(mode='mask')
    gt_bboxes = [
        AnnotatedObject(category_id=0, bbox=[0, 0, 1, 1],
                        segmentation=[[0, 0, 0, 1, 1, 1, 1, 0]]),
        AnnotatedObject(category_id=0, bbox=[1, 1, 1, 1],
                        segmentation=[[1, 1, 1, 2, 2, 2, 2, 1]]),
        AnnotatedObject(category_id=0, bbox=[2, 2, 1, 1],
                        segmentation=[[2, 2, 2, 3, 3, 3, 3, 2]]),
    ]
